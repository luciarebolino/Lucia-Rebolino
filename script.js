$('document').ready(function(){
	...
	for (i = 0; i < 19; i++) { // Updated loop to 19 for the new frame
		var getal = i + 1;
		var ide = 'col-' + getal; 
	...
	$('.column').mouseenter(function(){
		$(this).css('width', '50%');
		$('#info').css('width', '2.631578947368421%'); // Updated width to accommodate new frame count
	});
	$('.column').mouseleave(function(){
		$(this).css('width', '2.631578947368421%'); // Updated width for 19 frames
		$('#info').css('width', '50%');
	});
	...
	$('iframe').each(function(){
		...
		if (frameClass === 'col-1') {
			...
			// Open Folder
			var project = ['https://docs.google.com/document/d/e/2PACX-1vROOTmghFCf_A8y6sd39vX_MwdmIx5VOCB3PuATGY_QlbAWwjzltE7dHagfK_eVmCC9WjbXNoVOSYaN/pub?embedded=true'];
